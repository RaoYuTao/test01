...
public interface StudentDao {
    ...
    Student select24(Map map);

    List<Student> select25(String[] array);

    List<Student> select26(ArrayList<Integer> map);

    List<Map<String, Object>> select27();

    List<StudentAndClassVo2> select28();

    List<StudentAndClassVo2> select29(String z);
}
